...
public class W2 {
    public static void main(String[] args) throws IOException {
        ...
        /*
         * start += pow5[23]*1; start += pow5[26]*1; start += pow5[11]*2; start +=
         * pow5[13]*2; start += pow5[12]*3; start += pow5[25]*3; start += pow5[14]*4;
         * start += pow5[24]*4;
         */
        ...
        /*
         * long start = 13*19+16; start = (start*19+14)*19+15; start =
         * (start*19+11)*19+18; start = (start*19+12)*19+17;
         */
